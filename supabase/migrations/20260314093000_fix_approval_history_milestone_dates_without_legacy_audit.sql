...
AS $func$
  ...
  where
    ...
    and (p_claim_date is null or c.claim_date = p_claim_date)
    ...
    and (
      ...
      or (
        ...
        or (
          ...
          and exists (
            select 1
            from public.claim_statuses to_status
            where to_status.id = ah.new_status_id
              and to_status.approval_level = 3
              and to_status.is_approval = false
              and to_status.is_rejection = false
              and to_status.is_terminal = false
