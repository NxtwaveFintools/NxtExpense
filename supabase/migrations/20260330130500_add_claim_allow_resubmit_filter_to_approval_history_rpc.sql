DROP FUNCTION IF EXISTS public.get_filtered_approval_history(integer, timestamptz, uuid, text, text[], text, uuid, date, date, timestamptz, timestamptz, timestamptz, timestamptz);
DROP FUNCTION IF EXISTS public.get_filtered_approval_history(integer, timestamptz, uuid, text, text[], text, uuid, text, numeric, text, date, date, timestamptz, timestamptz, timestamptz, timestamptz);
DROP FUNCTION IF EXISTS public.get_filtered_approval_history(integer, timestamptz, uuid, text, text[], text, uuid, boolean, text, numeric, text, date, date, timestamptz, timestamptz, timestamptz, timestamptz);
