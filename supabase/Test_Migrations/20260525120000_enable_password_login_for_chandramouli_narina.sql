...
-- Enables email/password login for an existing auth user (chandramouli.narina@nxtwave.co.in).
-- This migration updates only the target account and does not create auth users.
DO $$
DECLARE
  v_target_email constant text := 'chandramouli.narina@nxtwave.co.in';
