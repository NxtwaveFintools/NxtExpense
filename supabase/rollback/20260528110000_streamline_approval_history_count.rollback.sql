-- Rollback: restore the LATERAL-based get_filtered_approval_history_count
-- (the definition introduced by 20260527140000). Reverts 20260528110000.
--
-- WARNING: this reinstates the per-visible-claim LATERAL subqueries, which is
-- the behaviour that peaked near the 8 s statement_timeout for large approvers.
