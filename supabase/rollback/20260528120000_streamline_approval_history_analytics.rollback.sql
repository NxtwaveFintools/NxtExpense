-- Rollback: restore the LATERAL-based get_approval_history_analytics
-- (the definition introduced by 20260527150000). Reverts 20260528120000.
--
-- WARNING: this reinstates the per-visible-claim LATERAL subqueries (~6 s for
-- large approvers). Only use to revert the 20260528120000 migration.
