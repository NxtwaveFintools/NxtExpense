-- Rollback: restore the original (truncating) generate_claim_number definition.
--
-- WARNING: this reinstates the lpad(..., 4, '0') truncation bug for any claim
-- numbers generated while the sequence is > 9999. Only use to revert the
-- 20260528100000 migration.
