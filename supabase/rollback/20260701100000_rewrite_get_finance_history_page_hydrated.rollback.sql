-- Rollback for 20260701100000_rewrite_get_finance_history_page_hydrated.sql
-- Restores the pre-hydration 3-column get_finance_history_page verbatim
-- (from 20260618092100_get_finance_history_page.sql). Same DROP-then-CREATE
-- requirement applies since the return-table shape is changing back.
