...
describe('emailPasswordLoginSchema', () => {
  describe('valid inputs', () => {
    it('accepts a valid email with @nxtwave.co.in', () => {
    ...
    it('accepts a valid email with @nxtwave.tech', () => {
      const result = emailPasswordLoginSchema.safeParse({
    ...
    it('accepts a valid email with @nxtwave.in', () => {
      const result = emailPasswordLoginSchema.safeParse({
    ...
    it('accepts a valid non-corporate email at schema level', () => {
      const result = emailPasswordLoginSchema.safeParse({
